...
export default function ImageCropper() {
  ...
  return (
    <div className="">
      <div className="">
        {(!preview && (
          <Card ref={cloudRef} className="border-2 border-dashed border-gray-200 bg-white/50 backdrop-blur-sm aspect-square text-red-400 h-[200px] sm:h-[300px] flex justify-center items-center">
