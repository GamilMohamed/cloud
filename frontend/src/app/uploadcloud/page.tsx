...
//     if (!user) {
//       window.location.href = "http://localhost:3000/api/auth/signin?callbackUrl=http://localhost:4000/allclouds";
//     }
//   }
...
//       <div className="">
//         {(!preview && (
//           <Card ref={cloudRef} className="border-2 border-dashed border-gray-200 bg-white/50 backdrop-blur-sm aspect-square text-red-400 h-[180px] sm:h-[300px] flex justify-center items-center">
